...
export class EditCtdStudiesComponent implements OnInit {
  ...
  ctdClinicalPKreportDescrption: string;
  ctdClinicalPKreportURL: string;

  ctdProtocolDescrption: string;
  ctdProtocolURL: string;
        ...
        (res) => {
          ...
          if (res.length !== 0) {
            ...
            this._appService.addDatatoList(url, {
              ...
              Title: this.ctdStudyNumber,
              ctdStudyName: this.ctdStudyName,
              ctdStudyConclusion: this.ctdStudyConclusion,
              ctdClinicalPKrep: this.ctdClinicalPKrep,
              ctdClinPharmRep: this.ctdClinPharmRep,
              ctdProtocol:
              {
                'Description': this.ctdProtocolDescrption,
                'Url': this.ctdProtocolURL
              },
              ctdClinicalPKreport:
              {
                'Description': this.ctdClinicalPKreportDescrption,
                'Url': this.ctdClinicalPKreportURL
              },
  ...
  setFormData(data: CompletedStudies): void {
    this.ctdStudyNumber = data[0].Title;//.toString();
    this.ctdStudyName = data[0].ctdStudyName;//.toString();
    ...
    this.ctdClinicalPKreportDescrption = (data[0].ctdClinicalPKreport !== null) ? data[0].ctdClinicalPKreport.Description : '';
    this.ctdClinicalPKreportURL = (data[0].ctdClinicalPKreport !== null) ? data[0].ctdClinicalPKreport.Url : '';
    this.ctdProtocolDescrption = (data[0].ctdProtocol !== null) ? data[0].ctdProtocol.Description : '';
    this.ctdProtocolURL = (data[0].ctdProtocol !== null) ? data[0].ctdProtocol.Url : '';
